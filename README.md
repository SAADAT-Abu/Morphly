...
response curves and IC50s, Kaplan-Meier survival curves, heatmaps, PCA,
correlation matrices, ROC curves, Bland-Altman, volcano, MA and forest plots,
Venn diagrams and UpSet plots. It suggests a statistical test and says why,
draws the comparisons you tick as brackets with stars, and writes you a methods
sentence to copy, with every p-value checked against R. **NIH BioArt** is still
inside the installer, so Morphly works offline the moment you open it. What
