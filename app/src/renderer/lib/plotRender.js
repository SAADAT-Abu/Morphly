...
export function defaultPlot(kind = "bar", { fontSize = 28 } = {}) {
  return {
    ...
    brackets: {},
    fit: false,
    // Settings for the graphs built for bioinformatics. Anything with a
    // sensible automatic choice is left out on purpose, so that Morphly can
    // go on choosing it until somebody says otherwise.
    palette: "diverging",
    scaleRows: "row",
    corrMethod: "pearson",
    labelTop: 10,
